<x-app-layout>
    <x-slot name="page_title">{{ $page_title ?? 'Question Create' }}</x-slot>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title"> Question Create </h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            <form action="{{ url('admin-panel/dashboard/questions') }}" method="POST" enctype="multipart/form-data">
                                @csrf
