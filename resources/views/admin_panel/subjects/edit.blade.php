<x-app-layout>
    <x-slot name="page_title">{{ $page_title ?? 'Subject Edit' }}</x-slot>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            <form action="{{ url('admin-panel/dashboard/subjects', $subject->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
